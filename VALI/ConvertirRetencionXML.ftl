...
<Retention xmlns="urn:sunat:names:specification:ubl:peru:schema:xsd:Retention-1"
	...
	<sac:SUNATRetentionSystemCode>${codRegRetencion}</sac:SUNATRetentionSystemCode>
	<sac:SUNATRetentionPercent>${tasRetencion}</sac:SUNATRetentionPercent>
	<cbc:Note><![CDATA[${desObsRetencion}]]></cbc:Note>
	<cbc:TotalInvoiceAmount currencyID="${tipMonRetencion}">${mtoTotRetencion}</cbc:TotalInvoiceAmount>
	<sac:SUNATTotalPaid currencyID="${tipMonImpTotPagRetencion}">${mtoImpTotPagRetencion}</sac:SUNATTotalPaid>	
	...
	<sac:SUNATRetentionDocumentReference>
		...
		<!-- Datos de la Retención del Pago -->	
		<sac:SUNATRetentionInformation>
			<sac:SUNATRetentionAmount currencyID="${detalle.tipMonRetDocRelacionado}">${detalle.mtoRetDocRelacionado}</sac:SUNATRetentionAmount>
			<sac:SUNATRetentionDate>${detalle.fecRetDocRelacionado}</sac:SUNATRetentionDate>
			<sac:SUNATNetTotalPaid currencyID="${detalle.tipMonTotPagNetoDocRelacionado}">${detalle.mtoTotPagNetoDocRelacionado}</sac:SUNATNetTotalPaid>
